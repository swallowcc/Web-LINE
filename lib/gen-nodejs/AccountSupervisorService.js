...
AccountSupervisorService_registerVirtualAccount_args = function(args) {
  ...
  if (args) {
    ...
    if (args.encryptedVirtualUserId !== undefined) {
...
AccountSupervisorService_requestVirtualAccountPasswordChange_args = function(args) {
  ...
  if (args) {
    if (args.virtualMid !== undefined) {
      this.virtualMid = args.virtualMid;
    }
    if (args.encryptedVirtualUserId !== undefined) {
      this.encryptedVirtualUserId = args.encryptedVirtualUserId;
    }
    if (args.encryptedOldPassword !== undefined) {
      this.encryptedOldPassword = args.encryptedOldPassword;
    }
    if (args.encryptedNewPassword !== undefined) {
...
AccountSupervisorServiceClient = exports.Client = function(output, pClass) {
    this.output = output;
    this.pClass = pClass;
    this._seqid = 0;
    this._reqs = {};
...
AccountSupervisorServiceProcessor = exports.Processor = function(handler) {
  ...
  if (this._handler.getRSAKey.length === 0) {
    Q.fcall(this._handler.getRSAKey)
      .then(function(result) {
        var result = new AccountSupervisorService_getRSAKey_result({success: result});
        output.writeMessageBegin("getRSAKey", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      }, function (err) {
        var result = new AccountSupervisorService_getRSAKey_result(err);
        output.writeMessageBegin("getRSAKey", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
    ...
    this._handler.getRSAKey( function (err, result) {
      var result = new AccountSupervisorService_getRSAKey_result((err != null ? err : {success: result}));
      output.writeMessageBegin("getRSAKey", Thrift.MessageType.REPLY, seqid);
      result.write(output);
      output.writeMessageEnd();
      output.flush();
...
AccountSupervisorServiceProcessor.prototype.process_notifyEmailConfirmationResult = function(seqid, input, output) {
  ...
  if (this._handler.notifyEmailConfirmationResult.length === 1) {
    Q.fcall(this._handler.notifyEmailConfirmationResult, args.parameterMap)
      .then(function(result) {
        var result = new AccountSupervisorService_notifyEmailConfirmationResult_result({success: result});
        output.writeMessageBegin("notifyEmailConfirmationResult", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      }, function (err) {
        var result = new AccountSupervisorService_notifyEmailConfirmationResult_result(err);
        output.writeMessageBegin("notifyEmailConfirmationResult", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
    ...
    this._handler.notifyEmailConfirmationResult(args.parameterMap,  function (err, result) {
      var result = new AccountSupervisorService_notifyEmailConfirmationResult_result((err != null ? err : {success: result}));
      output.writeMessageBegin("notifyEmailConfirmationResult", Thrift.MessageType.REPLY, seqid);
      result.write(output);
      output.writeMessageEnd();
      output.flush();
...
AccountSupervisorServiceProcessor.prototype.process_registerVirtualAccount = function(seqid, input, output) {
  ...
  if (this._handler.registerVirtualAccount.length === 3) {
    Q.fcall(this._handler.registerVirtualAccount, args.locale, args.encryptedVirtualUserId, args.encryptedPassword)
      .then(function(result) {
        var result = new AccountSupervisorService_registerVirtualAccount_result({success: result});
        output.writeMessageBegin("registerVirtualAccount", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      }, function (err) {
        var result = new AccountSupervisorService_registerVirtualAccount_result(err);
        output.writeMessageBegin("registerVirtualAccount", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
    ...
    this._handler.registerVirtualAccount(args.locale, args.encryptedVirtualUserId, args.encryptedPassword,  function (err, result) {
      var result = new AccountSupervisorService_registerVirtualAccount_result((err != null ? err : {success: result}));
      output.writeMessageBegin("registerVirtualAccount", Thrift.MessageType.REPLY, seqid);
      result.write(output);
      output.writeMessageEnd();
      output.flush();
...
AccountSupervisorServiceProcessor.prototype.process_requestVirtualAccountPasswordChange = function(seqid, input, output) {
  ...
  if (this._handler.requestVirtualAccountPasswordChange.length === 4) {
    Q.fcall(this._handler.requestVirtualAccountPasswordChange, args.virtualMid, args.encryptedVirtualUserId, args.encryptedOldPassword, args.encryptedNewPassword)
      .then(function(result) {
        var result = new AccountSupervisorService_requestVirtualAccountPasswordChange_result({success: result});
        output.writeMessageBegin("requestVirtualAccountPasswordChange", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      }, function (err) {
        var result = new AccountSupervisorService_requestVirtualAccountPasswordChange_result(err);
        output.writeMessageBegin("requestVirtualAccountPasswordChange", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
    ...
    this._handler.requestVirtualAccountPasswordChange(args.virtualMid, args.encryptedVirtualUserId, args.encryptedOldPassword, args.encryptedNewPassword,  function (err, result) {
      var result = new AccountSupervisorService_requestVirtualAccountPasswordChange_result((err != null ? err : {success: result}));
      output.writeMessageBegin("requestVirtualAccountPasswordChange", Thrift.MessageType.REPLY, seqid);
      result.write(output);
      output.writeMessageEnd();
      output.flush();
...
AccountSupervisorServiceProcessor.prototype.process_requestVirtualAccountPasswordSet = function(seqid, input, output) {
  ...
  if (this._handler.requestVirtualAccountPasswordSet.length === 3) {
    Q.fcall(this._handler.requestVirtualAccountPasswordSet, args.virtualMid, args.encryptedVirtualUserId, args.encryptedNewPassword)
      .then(function(result) {
        var result = new AccountSupervisorService_requestVirtualAccountPasswordSet_result({success: result});
        output.writeMessageBegin("requestVirtualAccountPasswordSet", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      }, function (err) {
        var result = new AccountSupervisorService_requestVirtualAccountPasswordSet_result(err);
        output.writeMessageBegin("requestVirtualAccountPasswordSet", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
    ...
    this._handler.requestVirtualAccountPasswordSet(args.virtualMid, args.encryptedVirtualUserId, args.encryptedNewPassword,  function (err, result) {
      var result = new AccountSupervisorService_requestVirtualAccountPasswordSet_result((err != null ? err : {success: result}));
      output.writeMessageBegin("requestVirtualAccountPasswordSet", Thrift.MessageType.REPLY, seqid);
      result.write(output);
      output.writeMessageEnd();
      output.flush();
...
AccountSupervisorServiceProcessor.prototype.process_unregisterVirtualAccount = function(seqid, input, output) {
  ...
  if (this._handler.unregisterVirtualAccount.length === 1) {
    Q.fcall(this._handler.unregisterVirtualAccount, args.virtualMid)
      .then(function(result) {
        var result = new AccountSupervisorService_unregisterVirtualAccount_result({success: result});
        output.writeMessageBegin("unregisterVirtualAccount", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      }, function (err) {
        var result = new AccountSupervisorService_unregisterVirtualAccount_result(err);
        output.writeMessageBegin("unregisterVirtualAccount", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
    ...
    this._handler.unregisterVirtualAccount(args.virtualMid,  function (err, result) {
      var result = new AccountSupervisorService_unregisterVirtualAccount_result((err != null ? err : {success: result}));
      output.writeMessageBegin("unregisterVirtualAccount", Thrift.MessageType.REPLY, seqid);
      result.write(output);
      output.writeMessageEnd();
      output.flush();
