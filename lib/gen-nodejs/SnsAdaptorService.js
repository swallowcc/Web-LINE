...
SnsAdaptorServiceClient = exports.Client = function(output, pClass) {
    this.output = output;
    this.pClass = pClass;
    this._seqid = 0;
    this._reqs = {};
...
SnsAdaptorServiceProcessor = exports.Processor = function(handler) {
  ...
  if (this._handler.getSnsFriends.length === 4) {
    Q.fcall(this._handler.getSnsFriends, args.snsIdType, args.snsAccessToken, args.startIdx, args.limit)
      .then(function(result) {
        var result = new SnsAdaptorService_getSnsFriends_result({success: result});
        output.writeMessageBegin("getSnsFriends", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      }, function (err) {
        var result = new SnsAdaptorService_getSnsFriends_result(err);
        output.writeMessageBegin("getSnsFriends", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
    ...
    this._handler.getSnsFriends(args.snsIdType, args.snsAccessToken, args.startIdx, args.limit,  function (err, result) {
      var result = new SnsAdaptorService_getSnsFriends_result((err != null ? err : {success: result}));
      output.writeMessageBegin("getSnsFriends", Thrift.MessageType.REPLY, seqid);
      result.write(output);
      output.writeMessageEnd();
      output.flush();
...
SnsAdaptorServiceProcessor.prototype.process_getSnsMyProfile = function(seqid, input, output) {
  ...
  if (this._handler.getSnsMyProfile.length === 2) {
    Q.fcall(this._handler.getSnsMyProfile, args.snsIdType, args.snsAccessToken)
      .then(function(result) {
        var result = new SnsAdaptorService_getSnsMyProfile_result({success: result});
        output.writeMessageBegin("getSnsMyProfile", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      }, function (err) {
        var result = new SnsAdaptorService_getSnsMyProfile_result(err);
        output.writeMessageBegin("getSnsMyProfile", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
    ...
    this._handler.getSnsMyProfile(args.snsIdType, args.snsAccessToken,  function (err, result) {
      var result = new SnsAdaptorService_getSnsMyProfile_result((err != null ? err : {success: result}));
      output.writeMessageBegin("getSnsMyProfile", Thrift.MessageType.REPLY, seqid);
      result.write(output);
      output.writeMessageEnd();
      output.flush();
...
SnsAdaptorServiceProcessor.prototype.process_postSnsInvitationMessage = function(seqid, input, output) {
  ...
  if (this._handler.postSnsInvitationMessage.length === 3) {
    Q.fcall(this._handler.postSnsInvitationMessage, args.snsIdType, args.snsAccessToken, args.toSnsUserId)
      .then(function(result) {
        var result = new SnsAdaptorService_postSnsInvitationMessage_result({success: result});
        output.writeMessageBegin("postSnsInvitationMessage", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      }, function (err) {
        var result = new SnsAdaptorService_postSnsInvitationMessage_result(err);
        output.writeMessageBegin("postSnsInvitationMessage", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
    ...
    this._handler.postSnsInvitationMessage(args.snsIdType, args.snsAccessToken, args.toSnsUserId,  function (err, result) {
      var result = new SnsAdaptorService_postSnsInvitationMessage_result((err != null ? err : {success: result}));
      output.writeMessageBegin("postSnsInvitationMessage", Thrift.MessageType.REPLY, seqid);
      result.write(output);
      output.writeMessageEnd();
      output.flush();
