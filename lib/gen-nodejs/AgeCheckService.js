...
AgeCheckService_checkUserAgeWithDocomo_args = function(args) {
  ...
  this.verifier = null;
  if (args) {
    if (args.openIdRedirectUrl !== undefined) {
...
AgeCheckServiceClient = exports.Client = function(output, pClass) {
    this.output = output;
    this.pClass = pClass;
    this._seqid = 0;
    this._reqs = {};
...
AgeCheckServiceProcessor = exports.Processor = function(handler) {
  ...
  if (this._handler.checkUserAge.length === 4) {
    Q.fcall(this._handler.checkUserAge, args.carrier, args.sessionId, args.verifier, args.standardAge)
      .then(function(result) {
        var result = new AgeCheckService_checkUserAge_result({success: result});
        output.writeMessageBegin("checkUserAge", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      }, function (err) {
        var result = new AgeCheckService_checkUserAge_result(err);
        output.writeMessageBegin("checkUserAge", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
    ...
    this._handler.checkUserAge(args.carrier, args.sessionId, args.verifier, args.standardAge,  function (err, result) {
      var result = new AgeCheckService_checkUserAge_result((err != null ? err : {success: result}));
      output.writeMessageBegin("checkUserAge", Thrift.MessageType.REPLY, seqid);
      result.write(output);
      output.writeMessageEnd();
      output.flush();
...
AgeCheckServiceProcessor.prototype.process_checkUserAgeWithDocomo = function(seqid, input, output) {
  ...
  if (this._handler.checkUserAgeWithDocomo.length === 3) {
    Q.fcall(this._handler.checkUserAgeWithDocomo, args.openIdRedirectUrl, args.standardAge, args.verifier)
      .then(function(result) {
        var result = new AgeCheckService_checkUserAgeWithDocomo_result({success: result});
        output.writeMessageBegin("checkUserAgeWithDocomo", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      }, function (err) {
        var result = new AgeCheckService_checkUserAgeWithDocomo_result(err);
        output.writeMessageBegin("checkUserAgeWithDocomo", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
    ...
    this._handler.checkUserAgeWithDocomo(args.openIdRedirectUrl, args.standardAge, args.verifier,  function (err, result) {
      var result = new AgeCheckService_checkUserAgeWithDocomo_result((err != null ? err : {success: result}));
      output.writeMessageBegin("checkUserAgeWithDocomo", Thrift.MessageType.REPLY, seqid);
      result.write(output);
      output.writeMessageEnd();
      output.flush();
...
AgeCheckServiceProcessor.prototype.process_retrieveOpenIdAuthUrlWithDocomo = function(seqid, input, output) {
  ...
  if (this._handler.retrieveOpenIdAuthUrlWithDocomo.length === 0) {
    Q.fcall(this._handler.retrieveOpenIdAuthUrlWithDocomo)
      .then(function(result) {
        var result = new AgeCheckService_retrieveOpenIdAuthUrlWithDocomo_result({success: result});
        output.writeMessageBegin("retrieveOpenIdAuthUrlWithDocomo", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      }, function (err) {
        var result = new AgeCheckService_retrieveOpenIdAuthUrlWithDocomo_result(err);
        output.writeMessageBegin("retrieveOpenIdAuthUrlWithDocomo", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
    ...
    this._handler.retrieveOpenIdAuthUrlWithDocomo( function (err, result) {
      var result = new AgeCheckService_retrieveOpenIdAuthUrlWithDocomo_result((err != null ? err : {success: result}));
      output.writeMessageBegin("retrieveOpenIdAuthUrlWithDocomo", Thrift.MessageType.REPLY, seqid);
      result.write(output);
      output.writeMessageEnd();
      output.flush();
...
AgeCheckServiceProcessor.prototype.process_retrieveRequestToken = function(seqid, input, output) {
  ...
  if (this._handler.retrieveRequestToken.length === 1) {
    Q.fcall(this._handler.retrieveRequestToken, args.carrier)
      .then(function(result) {
        var result = new AgeCheckService_retrieveRequestToken_result({success: result});
        output.writeMessageBegin("retrieveRequestToken", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      }, function (err) {
        var result = new AgeCheckService_retrieveRequestToken_result(err);
        output.writeMessageBegin("retrieveRequestToken", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
    ...
    this._handler.retrieveRequestToken(args.carrier,  function (err, result) {
      var result = new AgeCheckService_retrieveRequestToken_result((err != null ? err : {success: result}));
      output.writeMessageBegin("retrieveRequestToken", Thrift.MessageType.REPLY, seqid);
      result.write(output);
      output.writeMessageEnd();
      output.flush();
